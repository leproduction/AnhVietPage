...
function Home() {
  return (
    <Container fluid align="center" className="flex shadow px-1 py-1 rounded" style={{ background: 'rgba(189,195,199, 0.8)' }}>
      ...
      <PeopleCount />
      <Container fluid className="d-flex justify-content-center align-items-center flex-wrap my-2"></Container>
      <ProgressiveBar />
      <LandingPage />
      <ReviewPage />
      <Container fluid className='p-2 shadow d-flex justify-content-center align-items-center text-center'>
        <Row sm={1} md={1} className='mx-auto'>
          ...
          <Row className='col-md-12'><Col>Tuesday</Col><Col>9:00 A.M- 5 P.M</Col></Row>
          ...
          <Row className='col-md-12'><Col>Saturday</Col><Col>By Appointment</Col></Row>
          <Row className='col-md-12'><Col>Sunday</Col><Col>By Appointment</Col></Row>
        </Row>
      </Container>
      <ContactEmer />
      <FooterPage />
