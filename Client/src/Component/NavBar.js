...
const logOutButton=()=>{
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://anhvietapi.vercel.app/signin", {
        email,
        password,
        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              ...
              <NavDropdown.Item>  <Link to="/policy" className="text-decoration-none text-black">About & Policy </Link></NavDropdown.Item>
